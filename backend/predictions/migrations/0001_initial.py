    ...
    operations = [
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="predictions_model_t_424dee_idx",
                    )
                ],
                "constraints": [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["player"], name="predictions_player__8243b1_idx"
                    ),
                    models.Index(
                        fields=["season"], name="predictions_season__00c22e_idx"
                    ),
                    models.Index(
                        fields=["recorded_at"], name="predictions_recorde_2f3f1d_idx"
                    ),
                ],
                "constraints": [
                    models.UniqueConstraint(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["player"], name="predictions_player__f09e27_idx"
                    ),
                    models.Index(
                        fields=["created_at"], name="predictions_created_53f8e8_idx"
                    ),
                    models.Index(
                        fields=["model", "created_at"],
                        name="predictions_model_i_24dbd6_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["status"], name="predictions_status_964886_idx"
                    ),
                    models.Index(
                        fields=["started_at"], name="predictions_started_75b315_idx"
                    ),
                ],
                "constraints": [
